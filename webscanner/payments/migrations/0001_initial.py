...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Coupon'
        db.create_table('payments_coupon', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('used', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('code', self.gf('django.db.models.fields.CharField')(default='3c52ba158533bd768ffd', unique=True, max_length=256)),
            ('percent', self.gf('django.db.models.fields.IntegerField')()),
            ('used_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('payments', ['Coupon'])

        # Adding model 'Subscription'
        db.create_table('payments_subscription', (
            ('code', self.gf('django.db.models.fields.CharField')(default='e54b54eb3bba0b48246c', unique=True, max_length=512, primary_key=True)),
        ...
        db.create_table('payments_payment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subscription', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payments.Subscription'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('payments_coupon')
    ...
    models = {
        ...
        'payments.coupon': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'a9d423c71f8516214921'", 'unique': 'True', 'max_length': '256'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'payments.payment': {
            ...
            'subscription': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['payments.Subscription']"})
        },
        'payments.subscription': {
            'Meta': {'object_name': 'Subscription'},
            'code': ('django.db.models.fields.CharField', [], {'default': "'88c4a6b214bc7e09c9d0'", 'unique': 'True', 'max_length': '512', 'primary_key': 'True'}),
            'coupon': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['payments.Coupon']", 'null': 'True', 'blank': 'True'}),
            'date_canceled': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_eot': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
            'date_subscribed': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
