        ...
        try:
            ...
            if test:
                ...
                if test.vip_mode:
                    ...
                    cmd = PATH_HTTRACK + " --clean --referer webcheck.me -I0 -r1 --max-time=60 -%%P 1 --preserve --keep-alive -n --user-agent wh-webscanner -s0 -O %s %s %s +*"%(str(tmppath),wwwdomain, domain)
