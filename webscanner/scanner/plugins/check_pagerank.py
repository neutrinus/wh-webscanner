...
class PluginPagerank(PluginMixin):
    ...
    def run(self, command):
        ...
        res.output_full = unicode(_("<p>Alexa collects statistics about visits by internet users to websites through the Alexa Toolbar. Based on the collected data, Alexa computes site ranking.</p> <ul> <li>Popularity rank: %(pop_rank)s</li> <li>Reachability rank: %s</li></ul>"%(popularity_rank,reach_rank ) ))
