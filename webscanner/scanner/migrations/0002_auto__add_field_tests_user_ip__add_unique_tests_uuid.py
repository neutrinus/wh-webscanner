...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tests.user_ip'
        db.add_column('scanner_tests', 'user_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True), keep_default=False)

        # Adding unique constraint on 'Tests', fields ['uuid']
        db.create_unique('scanner_tests', ['uuid'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Tests', fields ['uuid']
        db.delete_unique('scanner_tests', ['uuid'])

        # Deleting field 'Tests.user_ip'
        db.delete_column('scanner_tests', 'user_ip')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 6, 23, 21, 47, 210854)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 6, 23, 21, 47, 210793)'}),
